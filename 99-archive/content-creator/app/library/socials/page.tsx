  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8">Social Media Library</h1>
        <p className="text-lg text-center mb-12 max-w-2xl mx-auto">
          Browse your collection of content creations.
        </p>
        ...
        {items.length === 0 ? (
          <div className="text-center p-8 border rounded-lg">
            <p className="text-lg mb-4">No content found in the library.</p>
