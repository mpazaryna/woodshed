  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8">Talks Library</h1>
        <p className="text-lg text-center mb-12 max-w-2xl mx-auto">
          Browse our collection of dharma talks with organized teaching points, examples, and practice guidance.
        </p>
