  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8">Video Scripts Library</h1>
        <p className="text-lg text-center mb-12 max-w-2xl mx-auto">
          Browse the collection of generated video scripts, each designed to captivate your audience with engaging content.
        </p>
