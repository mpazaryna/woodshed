...
require_relative "lib/about_update"

describe AboutUpdate do

  i_suck_and_my_tests_are_order_dependent!
  SEED = 10

  it "should seed the db with 10 records" do
    puts "test1"
    f = AboutUpdate.new
  ...
  it "should seed loop through the records" do
    puts "test2"
    f = AboutUpdate.new
    z = f.iterate_collection("device")
    assert_equal SEED, z
  end

  it "should seed the db2 with 10 records" do
    puts "test3"
    f = AboutUpdate.new
    z = f.bulk_load(SEED, "device")
    assert_equal SEED, z
