...
def main():
    ...
    for url in urls:
        ...
        # Extract content within <div class="sqs-html-content">
        page_body = soup.find("div", class_="sqs-html-content")

        if not page_body:
            print(f"No <div class='sqs-html-content'> found in {url}. Skipping...")
            continue
